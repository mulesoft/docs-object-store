...
* For the Retrieve All and Retrieve All Keys operations, the size of all key-value pairs in the object store partition counts towards billable units.
+
...
* For each Store operation, the size of the item being inserted or updated counts towards billable units.
+
