...
+
Each transaction (such as create, modify, or delete) on a store or an item counts as one or more billable units against the quota, 
based on the size of the payload and the number of keys.
