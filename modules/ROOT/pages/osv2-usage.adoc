...
|Delete all keys and values in the partition| | One billable unit
|Delete key | | One billable unit
|===
...
[NOTE]
These REST APIs aren't supported on Hyperforce (Canada Cloud or Japan Cloud).
To retrieve these usage metrics on Hyperforce, see <<retrieve-metrics-metering-api>>.
...
[NOTE]
These REST APIs are supported on Hyperforce only.

To retrieve Object Store v2 usage metrics on Hyperforce (Canada Cloud or Japan Cloud), use the Metering API.
