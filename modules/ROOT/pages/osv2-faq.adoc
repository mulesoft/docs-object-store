...
To share data between Mule 4 apps using Object Store v2, create a flow to retrieve the data using Retrieve operation in the Object Store Connector for Mule 4.
