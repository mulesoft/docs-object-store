...
The free version also limits usage to 10 transactions per second (TPS).
...
In Object Store v1, the limit was 100,000 keys and attempts to store more were rejected.
