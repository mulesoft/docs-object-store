...
3+h| https://in1.platform.mulesoft.com[India Cloud]
.1+| APAC |            India       | `ap-south-1` <<os-hyperforce,^***^>>
...
Object Store v2 uses Transport Layer Security (TLS) 1.2 and 1.3 for secure transport and
doesn't support the deprecated TLS versions 1.0 and 1.1.
