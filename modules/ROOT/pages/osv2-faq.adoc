...
No. 
You can use Object Store v2 only as a distributed memory store for an application or as a key-value cache. 
It is not designed for app-to-app communication. 
