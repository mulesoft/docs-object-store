...
== Does Object Store v2 support distributed locking for key updates?

Because CloudHub doesn't support distributed locking, errors or data discrepancies can occur if any components that use Object Store v2 attempt to update a key simultaneously.
You can use other synchronization mechanisms to synchronize access to Object Store v2.
