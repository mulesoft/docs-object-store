...
NOTE: Mule 4 only supports Object Store v2. Recent Mule 3 versions can work with either OSv2 or OSv1.
...
You can then view the value for a key using this curl command:

`+curl http://LINK_FROM_RUNTIME_MANAGER/retrieve?key=MyKey+`

Replace LINK_FROM_RUNTIME_MANAGER with the cloudhub.io URL you obtained from Runtime Manager when you deployed your application to CloudHub. 
