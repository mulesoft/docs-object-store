...
** If the data is accessed at least once a week in the 30 days after key creation, the TTL is extended for another 30 days.
+
As long as the data continues being accessed once a week, it is not evicted.
