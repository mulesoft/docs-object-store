...
Object Store v2 allows up to 100 million transactions for Object Store v2 for an Anypoint Platform organization. This limit is applied to both Production and non-Production environments.
You can use the https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/object-store-v2/[Object Store REST API] to monitor usage.
