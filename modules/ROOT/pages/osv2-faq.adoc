...
You can use the https://dev-portal.mulesoft.com/apis/object-store-v2-stats.html[Object Store v2 Stats API] to monitor usage.
...
* https://dev-portal.mulesoft.com/apis/object-store-v2-stats.html[Object Store v2 Stats]
