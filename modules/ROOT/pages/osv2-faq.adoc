...
Object Store v2 is available in every xref:runtime-manager::cloudhub-networking-guide.adoc#regional-services[region] where CloudHub apps can be deployed.
