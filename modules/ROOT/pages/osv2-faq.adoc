...
Otherwise, it is evicted in the next 7 to 30 days from the last expiration date.
[NOTE]
Rolling TTL is available for all apps using Mule version 4.2.x, 4.3.0, and later.
