...
You have successfully used Design Center to configure an app with an object store.
...
. In Design Center, click the copy link icon to copy the deployment URL:
+
.The arrow shows the deployment URL in the details pane for your app in Design Center.
image::os-tutorial-dc-deploy-url.png[Deployment URL in Design Center]
