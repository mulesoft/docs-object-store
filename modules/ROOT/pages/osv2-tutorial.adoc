...
+
[IMPORTANT]
Do not select an object store global element from the *Object store* menu.
...
[NOTE]
Object Store v2 provides persistent storage of objects with a time to live (TTL) of up to 30 days.
