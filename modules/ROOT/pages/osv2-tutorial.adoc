...
+
. Click *Trigger* and enter `H` to search for the HTTP Listener:
+
...
. In the *Connector configuration* menu, select the same *HTTP_Listener_config* option that you set up for the Listener in the Store flow:
+
