...
You now have a completed Studio application.
You can test that it runs correctly by right-clicking the project and selecting *Run As > Mule Application*.
This is just a test. Once you get your application to run, you can stop it.
