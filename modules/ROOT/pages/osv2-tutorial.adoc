...
In this tutorial, you create an app one in Anypoint Studio:
...
Depending on your Mule version, you create your app in Studio 7.x (Mule 4.x) or Studio 6.x (Mule 3.9).
...
** Studio 6.x
+
See xref:6.x@studio::to-download-and-install-studio.adoc[Downloading and Installing Anypoint Studio].
--
...
After you create your app in Studio 6.x, test it by using a `curl` command to submit a REST API command to the Object Store API and use Runtime Manager to view the results.
