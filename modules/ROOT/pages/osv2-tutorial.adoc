...
+
The maximum number of characters in a key is 256.
. Configure separate partitions, if required:
+
...
. From the *Object store* menu, select the object store configuration for the partition to associate with the object store.
