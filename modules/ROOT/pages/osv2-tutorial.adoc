...
download and install https://curl.haxx.se/[curl]. Alternatively, you can use Postman or browser plugins instead of curl.
...
For your future use of Object Store in Design Center, you don't need to view the Runtime Manager interface each
