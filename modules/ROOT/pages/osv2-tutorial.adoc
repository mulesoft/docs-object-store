...
download and install curl from the net.
...
For future use of Object Store, you don't need to go to the Object Store interface each
time you update the Object Store. After you create your application in Design Center, you can
