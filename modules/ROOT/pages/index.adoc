...
* xref:osv2-usage.adoc#osv2-usage-charts[Usage graphs] are not available.
* The xref:osv2-apis.adoc#osv2-stats-api[Object Store v2 Stats API] is not supported.
