...
+
See xref:osv2-guide.adoc#configure-os-conn-app[Configure a Connected App].
...
If the `entryTtl` value is below 1 second, TTL is set to the minimum value of 1 second without returning an error.
//Shared Static TTL 
include::partial$osv2-faq.adoc[tag=faqStaticTTL]
