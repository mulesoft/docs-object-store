...
[%header,cols="3a,1a,1a"]
|===
|Object Store Feature 
|https://anypoint.mulesoft.com/[US Cloud] and https://eu1.anypoint.mulesoft.com/[EU Cloud]
|https://ca1.platform.mulesoft.com/[Canada Cloud] and https://jp1.platform.mulesoft.com/[Japan Cloud] (Hyperforce)
...
* xref:osv2-usage.adoc#osv2-usage-charts[Usage Reports] (Access Management)
...
* xref:os-usage-apis.adoc#retrieve-metrics-metering-api[Anypoint Metering Query API] (Usage Metrics)
...
Object Store v2 supports these 
Salesforce Hyperforce (Hyperforce) regions:

* Canada Central (ca-central-1)
* Japan (ap-northeast-1)

For information about Hyperforce, see
xref:hyperforce::index.adoc[].

=== Object Store v2 Features Not Supported on Hyperforce

When you deploy to
https://ca1.platform.mulesoft.com[Canada Cloud] or 
...
+
You can deploy apps to CloudHub 2.0 shared spaces and Anypoint Runtime Fabric.
Usage Graphs::
xref:osv2-usage.adoc#osv2-usage-charts[Usage charts] aren't available.
REST APIs::
The https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/object-store-v2-stats/[Object Store v2 Stats API] isn't supported.
