...
NOTE: CloudHub applications that use Mule 4 can enable use of Object Store v2 or in-memory Object Store. On-premises Mule 4 applications do not use Object Store v2, but instead store data locally to a persistent data store. Object Store v2 can only be used in CloudHub.
