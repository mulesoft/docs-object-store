...
Otherwise, the object store evicts the date in the next 7 to 30 days from the most recent expiration date.
...
If the `entryTtl` value exceeds 30 days, TTL is the maximum value of 2592000 seconds (30 days) without returning an error.
