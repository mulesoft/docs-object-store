...
+
This behavior occurs because the "Distributed Locking" feature is not available in CloudHub when working with Object Store v2. As a result, under certain conditions, when multiple Mule components attempt to update Object Store v2 tables simultaneously, such calls may fail.
+
