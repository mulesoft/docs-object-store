...
+
Accessing the data during the last seven days of the period defined by the configured TTL extends the TTL for another 30 days.
...
of the period defined by the configured TTL extends the TTL for another 30 days.
