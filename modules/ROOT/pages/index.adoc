...
* Because Object Store v2 doesn't include a distributed locking mechanism for keys,
it cannot guarantee data consistency when keys are updated simultaneously.
+
Object Store v2 is not supported for use with multi-worker CloudHub applications.
