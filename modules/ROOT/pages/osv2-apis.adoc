...
| `object-store-eu-west-1.anypoint.mulesoft.com` | Europe (London)
| `object-store-eu-west-2.anypoint.mulesoft.com` | Europe (Ireland)
...
----
curl -X GET \
 'https://BASE_URL/api/v1/organizations/ORG_ID/environments/ENV_ID/regions' \
 -H 'authorization: Bearer ACCESS_TOKEN'
