...
Anypoint Object Store v2 (Object Store v2) provides a REST API that enables you to get and store `key,list` values.
...
* Object Store:
** TTL in seconds for the object store. The maximum TTL is 2,592,000 seconds (30 days). See xref:osv2-faq.adoc#how-long-can-data-persist-in-object-store-v2[How long can data persist in Object Store v2?]
