...
Anypoint Object Store v2 (Object Store v2) provides a REST API that lets you get and store `key,list` values.
...
See xref:osv2-faq.adoc#how-long-can-data-persist-in-object-store-v2[How long can data persist in Object Store v2?] The maximum number of keys you can obtain in each GET operation is 25.
...
* Object Store:
** TTL in seconds for the object store - by default the TTL is 2,592,000 seconds (30 days). See xref:osv2-faq.adoc#how-long-can-data-persist-in-object-store-v2[How long can data persist in Object Store v2?]
...
== Object Store V2 Data Center Locations

The following REST domains can be used for the application locations with Object Store:

[%header,cols="10a,80a"]
|===
|Control Plane|Domain
.9+|prod | object-store-us-east-2.anypoint.mulesoft.com/api/v1/ping
| object-store-us-west-1.anypoint.mulesoft.com/api/v1/ping
| object-store-us-west-2.anypoint.mulesoft.com/api/v1/ping
| object-store-ap-southeast-1.anypoint.mulesoft.com/api/v1/ping
| object-store-ap-southeast-2.anypoint.mulesoft.com/api/v1/ping
| object-store-ap-northeast-1.anypoint.mulesoft.com/api/v1/ping
| object-store-ca-central-1.anypoint.mulesoft.com/api/v1/ping
| object-store-eu-west-2.eu1.anypoint.mulesoft.com/api/v1/ping
| object-store-sa-east-1.anypoint.mulesoft.com/api/v1/ping
.2+|prod-eu | object-store-eu-central-1.eu1.anypoint.mulesoft.com/api/v1/ping
| object-store-eu-west-1.eu1.anypoint.mulesoft.com/api/v1/ping
|===
