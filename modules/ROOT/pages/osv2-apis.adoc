...
+
See
https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/access-management-api/minor/1.0/pages/Authentication/[Authentication] in 
...
Use `storeID` in place of STORE_ID in the examples that follow. 
...
(for example, between July 11, 2020 and September 11, 2020),
...
To view Object Store usage statistics for an environment (for example, between June 13, 2020 and September 13, 2020),
submit a `curl` command similar to the following, 
