...
To get the bearer token, you need the client ID and client secret for the app or connected app.
+
See <<get-bearer-token>>.
* <<osv2-stats-api>>
+
...
* Prepare to authenticate with the Object Store APIs:
...
https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/access-management-api/minor/1.0/pages/home/[Access Management API] and <<get-access-token>>.
...
[[get-bearer-token]]
=== Get a Bearer Token to Authenticate with Object Store v2 API

////

* If MFA is enabled, use a connected app to get the access token:
+
...
----
+
The output includes the access token:
+
[source,console,linenums]
----
{
...
----
* If MFA isn't enabled, run the following command:
+
[source,console,linenums]
----
curl -H \
...
For non-SSO users, to get the token:

. Get the client ID and the client secret for the app:
...
+
See also the `/accounts/oauth2/token` endpoint in the
https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/access-management-api/minor/1.0/pages/home/[Access Management API].
...
To use a connected app with the Object Store v2 REST APIs:

. xref:osv2-connected-apps.adoc[Create a connected app].
...
** https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/access-management-api/minor/1.0/pages/Connected%20App%20Examples/[Connected App Examples] in the Access Management API to get the access token.
...
[[get-access-token]]
=== Get an Access Token to Authenticate with Object Store v2 Stats API
