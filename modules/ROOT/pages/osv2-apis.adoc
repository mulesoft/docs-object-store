...
| Canada Cloud| `object-store-ca-central-1.ca1.platform.anypoint.mulesoft.com` | Canada (Central)
.2+|Japan Cloud | `object-store-ca-central-1.jp1.platform.anypoint.mulesoft.com` | Asia Pacific (Tokyo)
|===
