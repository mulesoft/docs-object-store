...
To view the list of object stores, run a `curl` command similar to the following, replacing 
...
xref:osv2-usage.adoc#retrieve-metrics-metering-api[Retrieve Usage Metrics with Anypoint Metering Query API].
