...
See xref:osv2-faq.adoc#how-long-can-data-persist-in-osv2[How long can data persist in Object Store v2?].
...
* Object Store:
** TTL in seconds for the object store - by default the TTL is 2,592,000 seconds (30 days). See xref:osv2-faq.adoc#how-long-can-data-persist-in-osv2[How long can data persist in OSv2?].
...
* xref:connectors::object-store/object-store-connector.adoc[Mule 4 Object Store Connector documentation]
