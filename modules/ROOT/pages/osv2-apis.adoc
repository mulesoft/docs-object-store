...
+
--
`+https://BASE_URL/api/v1/organizations/ORG_ID/environments/ENV_ID?startDate=...&endDate=...&period=...+`
...
|===
|Control Plane|BASE_URL | Region 
|`prod` | `object-store-us-east-1.anypoint.mulesoft.com` | US East (N. Virginia)
|`prod-eu` | `object-store-eu-central-1.eu1.anypoint.mulesoft.com` | Europe (Frankfurt)
|===
--
. Configure the application with HTTP headers and body for values to store to or read from
the object store.
