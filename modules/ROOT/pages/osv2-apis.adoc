...
To get client ID and client secret for the app:
...
+
For more information about TTL options and behavior, see xref:osv2-faq.adoc#how-long-can-data-persist-in-object-store-v2[How long can data persist in Object Store v2?]
