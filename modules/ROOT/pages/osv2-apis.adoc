...
replacing AUTH_SERVER_HOST with the URL of the authorization server, for example `\https://anypoint.mulesoft.com/`: 
+
...
. Run the following command, replacing AUTH_SERVER_HOST with the URL of the authorization server, for example `\https://anypoint.mulesoft.com/`:
+
[source,bash,linenums]
----
curl -H \
...
To get the ORG_ID, run this command, replacing AUTH_SERVER_HOST with the URL of the authorization server:
...
To get the ENV_ID, run this command, replacing AUTH_SERVER_HOST with the URL of the authorization server:
