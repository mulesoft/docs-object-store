...
+
The maximum TTL is 2,592,000 seconds (30 days).
...
For more information about TTL, see xref:osv2-faq.adoc#how-long-can-data-persist-in-object-store-v2[How long can data persist in Object Store v2?]
