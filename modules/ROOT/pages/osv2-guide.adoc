...
A custom time to live (TTL) period applies to the key-value pair defined in the object store configuration.
You can set different TTL value for key-value pairs in different partitions.
